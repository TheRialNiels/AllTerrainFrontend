  ...
  <Modal @close="props.closeModal" :escapable="false" :size="'5xl'">
    <template #body>
      <div class="my-10 flex flex-col items-center justify-center">
        ...
        <p class="mb-5 text-center">Contador de vueltas al circuito</p>
        ...
        <table class="table-auto border-collapse border border-black">
          <thead>
            <tr>
              ...
              <th class="border border-black px-4 py-2">Vueltas</th>
            </tr>
          </thead>
          <tbody>
...
const returnSubtotal = () => {
  props.form.rubricaResistencia = subtotal;
  props.form.rubricaResistenciaCalificado = true;

  emit("get-subtotal", 7, subtotal);
};
</script>
