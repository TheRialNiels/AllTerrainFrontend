<template>
    <Modal @close="props.closeModal" :escapable="false" :size="'5xl'">
      <template #body>
        <div class="my-10 flex flex-col items-center justify-center">
          <h1 class="mb-2 text-2xl font-bold">Rubrica de tiempo de hill and traction</h1>
          <p class="mb-5 text-center">
            El vehículo deberá completar el circuito sin ayuda externa de los integrantes del equipo.
          </p>
          ...
          <p class="my-5 text-center">
            <span class="font-bold">Nota:</span> Cada intervención de los integrantes del equipo se considerará como una penalización de 5 segundos más, y cada obstáculo que se derribe se considerará 1 segundo más.
          </p>
        </div>
  ...
  const content = reactive({
    rubrica: [
      {
        id: 1,
        nombre: "Tiempo en terminar el hill and traction 1ª vez:",
        tiempo: 0,
      },
      {
        id: 2,
        nombre: "Tiempo en terminar el hill and traction 2ª vez:",
        tiempo: 0,
      },
    ],
  });
  ...
  const returnTime = () => {
    props.form.hillTractionPrimeraVez = content.rubrica[0].tiempo;
    props.form.hillTractionSegundaVez = content.rubrica[1].tiempo;
    props.form.hillTractionCalificado = true;
  
    emit("get-time", 5, content.rubrica);
  };
  </script>
