  ...
  <Modal @close="props.closeModal" :escapable="false" :size="'5xl'">
    <template #body>
      <div class="my-10 flex flex-col items-center justify-center">
        <h1 class="mb-2 text-2xl font-bold">Rubrica de tiempo de vuelta</h1>
...
const content = reactive({
  rubrica: [
    {
      id: 1,
      nombre: "Tiempo en terminar el circuito 1ª vez:",
      tiempo: 0,
    },
    {
      id: 2,
      nombre: "Tiempo en terminar el circuito 2ª vez:",
      tiempo: 0,
    },
  ],
});
